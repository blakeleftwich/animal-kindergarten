--Pete the Frog: Subtraction to 5
return {
	game1 = {
			gameType = "question",
			nextWaypoint = false,
	...
	game3 = {
			gameType = "equation",
			nextWaypoint = false,
			question = { line1 = "Solve the equation.", offsetY = -30 },
			equation = { scale = .85, offsetY = 9 },
	...
	game4 = {
			gameType = "question",
			grayBGY = 115,
			question = { spacing = 35, scale = .8, offsetY = -41.5 },
